...
<form action="<?php echo JRoute::_('index.php?option=com_flexicontent&view=debuguser&user_id='.(int) $this->state->get('filter.user_id'));?>" method="post" name="adminForm" id="adminForm">
