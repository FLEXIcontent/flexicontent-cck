 ...
 * @since 1.0
 */
class FlexicontentViewTagelement extends JViewLegacy {
	...
	function display($tpl = null)
	{
		...
		$document->addStyleSheet(JURI::root(true).'/components/com_flexicontent/assets/css/flexicontent.css?v='.FLEXI_VERSION);
