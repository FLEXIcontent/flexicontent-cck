...
<div class="fctabber" id="uploader_tabset">
	<?php
...
<?php } ?>
	...
	<?php endif; ?>
	<div class="tabbertab" style="padding: 8px 16px 16px;" id="local_tab" data-icon-class="icon-info">
		<h3 class="tabberheading"> <?php echo JText::_( 'FLEXI_FILE_INFO' ); ?> </h3>
