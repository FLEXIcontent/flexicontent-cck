...
$videoFileExtensions = array(
	...
	"mpg",    // Moving Picture Experts Group format (short form)
	"webm",   // WebM format
	"vob",    // Video Object
	"ogv",    // Ogg Video
	"m4v",    // MPEG-4 Video
              ...
              <tr class="<?php echo 'row' . ($k % 2); ?>">
                ...
                <td class="col_title smaller">
					...
					if (!$isFilesElement)
					{
						...
						if (in_array($ext,  $audioFileExtensions) || in_array($ext,  $videoFileExtensions))
							echo \Joomla\CMS\HTML\HTMLHelper::_($hlpname . '.edit_link', $row, $i, true, array(
								...
								'keyname'  => 'mm_id',
								'noTitle'  => true,
								'linkedPrefix' => (in_array($ext,  $audioFileExtensions) ? '<span class="icon-music"></span>' :  '<span class="icon-video"></span>'),
								'attribs' => array(
