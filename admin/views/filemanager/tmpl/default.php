...
$secure_folder_tip  = '<i data-placement="bottom" class="icon-info purple fc-man-icon-s '.$tip_class.'" alt="'.$_folder_type_title.'" title="'.flexicontent_html::getToolTip($_folder_type_title, $_folder_type_desc, 0, 1).'"></i>';
    ...
    <div id="j-main-container">
      ...
      <div class="fctabber" id="fileman_tabset"> 
        ...
        <div class="tabbertab" id="filelist_tab" data-icon-class="icon-list">
          ...
          <form action="index.php?option=<?php echo $this->option; ?>&view=<?php echo $this->view; ?>" method="post" name="adminForm" id="adminForm">
            ...
            <div id="fc-filters-box" <?php if (!$this->count_filters) echo 'style="display:none;"'; ?> class=""> 
              ...
              <span class="fc-filter nowrap_box"> <?php echo $this->lists['language']; ?> </span> <span class="fc-filter nowrap_box"> <?php echo $this->lists['url']; ?> </span> <span class="fc-filter nowrap_box"> <?php echo $this->lists['secure']; ?> </span> <span class="fc-filter nowrap_box"> <?php echo $this->lists['ext']; ?> </span> <span class="fc-filter nowrap_box">
              <?php if ($this->CanViewAllFiles) echo $this->lists['uploader']; ?>
              &nbsp; &nbsp; &nbsp;
              <label class="label">Item ID</label>
              <?php echo $this->lists['item_id']; ?> </span>
            ...
            <div class="fcclear"></div>
            <table id="adminListTableFCfiles" class="adminlist fcmanlist table no-border hover">
              <thead>
                <tr class="header">
                  ...
                  <th class="left"> <?php echo JHTML::_('grid.sort', 'FLEXI_FILENAME', 'f.filename_displayed', $this->lists['order_Dir'], $this->lists['order'] ); ?> / <?php echo JHTML::_('grid.sort', 'FLEXI_FILE_DISPLAY_TITLE', 'f.altname', $this->lists['order_Dir'], $this->lists['order'] ); ?> </th>
                  ...
                  <th class="center hideOnDemandClass hlang"><?php echo JText::_( 'FLEXI_LANGUAGE' ); ?></th>
                  <?php if ($this->folder_mode) : ?>
                  ...
                  <?php if (!$this->folder_mode) : ?>
                  <th class="center hideOnDemandClass  hidden-tablet hidden-phone" nowrap="nowrap"><?php echo JHTML::_('grid.sort', 'FLEXI_ID', 'f.id', $this->lists['order_Dir'], $this->lists['order'] ); ?></th>
                  <?php endif; ?>
                </tr>
              </thead>
              <tbody>
                ...
                <tr class="<?php echo "row$k"; ?>">
                  ...
                  <?php endif; ?>
                  <td class="center"><?php echo ' <a href="index.php?option=com_flexicontent&amp;'.$ctrl_task.'edit&amp;cid[]='.$row->id.'" title="'.$edit_entry.'">'.$thumb_or_icon.'</a>'; ?></td>
                  <td align="left"><?php
							if (JString::strlen($row->filename_displayed) > 100) {
								$filename_cut = JString::substr( htmlspecialchars($row->filename_displayed, ENT_QUOTES, 'UTF-8'), 0 , 100).'...';
							} else {
                    ...
                    <?php
						...
						?></td>
                  <?php if (!$this->folder_mode) { ?>
                  <td class="center"><?php echo JHTML::_('jgrid.published', $row->published, $i, 'filemanager.' ); ?></td>
                  <?php } ?>
                  <td class="center"><?php
                  ...
                  <?php
		   		...
		   		?>
                  <td class="center col_lang hlang"><?php if ( 0 && !empty($row->language) && !empty($this->langs->{$row->language}->imgsrc) ) : ?>
                  ...
                  <?php endif; ?>
                  <td class="center"><span class="nowrap_box"><?php echo $row->assigned; ?></span>
                    <?php if ($row->count_assigned) : ?>
                    <br/>
                    <br/>
                    <span class="badge badge-info"><?php echo count($row->itemids); ?></span> <a href="<?php echo $items_link; ?>"> [<?php echo $view_entry;?>] </a>
                    <?php endif; ?></td>
                  <td class="center"><?php if ($permissions->CanAuthors) :?>
                    <a target="_blank" href="index.php?option=com_flexicontent&amp;<?php echo $ctrl_task_authors; ?>edit&amp;hidemainmenu=1&amp;cid[]=<?php echo $row->uploaded_by; ?>"> <?php echo $row->uploader; ?> </a>
                    <?php else :?>
                    <?php echo $row->uploader; ?>
                    <?php endif; ?></td>
                  <td class="center"><?php echo JHTML::Date( $row->uploaded, JText::_( 'DATE_FORMAT_LC2' ) ); ?></td>
            ...
            <?php
				...
				?>
            <span class="fc_legend_box <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILE_ITEM_ASSIGNMENTS_LEGEND', 'FLEXI_FILE_ITEM_ASSIGNMENTS_LEGEND_TIP', 1, 1); ?> " ><?php echo JText::_('FLEXI_FILE_ITEM_ASSIGNMENTS_LEGEND'); ?></span> : &nbsp; <?php echo implode(' &nbsp; &nbsp; | &nbsp; &nbsp; ', $field_legend); ?>
            <?php endif; ?>
        ...
        <form action="index.php?option=com_flexicontent&amp;<?php echo $ctrl_task; ?>ftpValidate" name="ftpForm" id="ftpForm" method="post">
          <fieldset title="<?php echo JText::_( 'FLEXI_DESCFTPTITLE' ); ?>" class="form-horizontal">
            <legend><?php echo JText::_( 'FLEXI_DESCFTPTITLE' ); ?></legend>
            <?php echo JText::_( 'FLEXI_DESCFTP' ); ?>
            <div class="adminform nospace form-horizontal">
        ...
        <fieldset class="filemanager-tab" >
          <?php
			...
			echo '
			<p class="wellx"><span class="fc-fileman-upload-limits-box">
          ...
          <fieldset class="actions" id="filemanager-1">
            <form action="<?php echo JURI::base(); ?>index.php?option=com_flexicontent&amp;<?php echo $ctrl_task; ?>upload&amp;<?php echo $session->getName().'='.$session->getId(); ?>" name="uploadFileForm" id="uploadFileForm" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="fc-form-tbl" id="file-upload-form-container">
                <div class="control-group" id="file-upload-lbl-container">
                  <div class="control-label">
                    <label class="label <?php echo $tip_class; ?>" id="file-upload-lbl" for="file-upload" title="<?php echo flexicontent_html::getToolTip('FLEXI_CHOOSE_FILE', 'FLEXI_CHOOSE_FILE_DESC', 1, 1); ?>"> <?php echo JText::_( 'FLEXI_CHOOSE_FILE' ); ?></label>
                  </div>
                  <div id="file-upload-container" class="controls">
                ...
                <?php if (!$this->folder_mode) { ?>
                <div class="control-group">
                  <div class="control-label" id="file-title-lbl-container" class="key <?php echo $tip_class; ?>">
                  <label class="label <?php echo $tip_class; ?>" id="file-title-lbl" for="file-title" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILE_DISPLAY_TITLE', 'FLEXI_FILE_DISPLAY_TITLE_DESC', 1, 1); ?>"> <?php echo JText::_( 'FLEXI_FILE_DISPLAY_TITLE' ); ?></label>
                </div>
              ...
              <?php } ?>
              <?php if (!$this->folder_mode) { ?>
              <div class="control-group hlang">
                <div class="control-label" id="file-lang-lbl-container">
                  <label class="label <?php echo $tip_class; ?>" id="file-lang-lbl" for="file-lang" title="<?php echo flexicontent_html::getToolTip('FLEXI_LANGUAGE', 'FLEXI_FILE_LANGUAGE_DESC', 1, 1); ?>"><?php echo JText::_( 'FLEXI_LANGUAGE' ); ?></label>
                </div>
                <div class="controls" id="file-lang-container"> <?php echo $this->lists['file-lang']; ?> </div>
              </div>
              <div class="control-group">
                <div class="control-label" id="file-desc-lbl-container">
                  <label class="label <?php echo $tip_class; ?>" id="file-desc-lbl" for="file-desc_uploadFileForm" title="<?php echo flexicontent_html::getToolTip('FLEXI_DESCRIPTION', 'FLEXI_FILE_DESCRIPTION_DESC', 1, 1); ?>"><?php echo JText::_( 'FLEXI_DESCRIPTION' ); ?></label>
                </div>
                <div class="controls" id="file-desc-container" valign="top" rowspan="2">
                  <textarea name="file-desc" cols="24" rows="3" id="file-desc_uploadFileForm"></textarea>
                </div>
              </div>
              <div class="control-group">
                <div class="control-label" id="secure-lbl-container">
                  <label id="secure-lbl" class="label <?php echo $tip_class; ?>" data-placement="bottom" title="<?php echo flexicontent_html::getToolTip('FLEXI_CHOOSE_DIRECTORY', 'FLEXI_CHOOSE_DIRECTORY_DESC', 1, 1); ?>"><?php echo JText::_( 'FLEXI_URL_SECURE' ); ?> </label>
                </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="submit" id="file-upload-submit" class="<?php echo $btn_class;?> btn-primary" value="<?php echo JText::_( 'FLEXI_START_UPLOAD' ); ?>"/>
                  <span id="upload-clear"></span> <?php echo JHTML::_( 'form.token' ); ?>
      ...
      <div class="tabbertab" id="fileurl_tab" data-icon-class="icon-out">
        ...
        <form action="<?php echo JURI::base(); ?>index.php?option=com_flexicontent&amp;<?php echo $ctrl_task; ?>addurl&amp;<?php echo $session->getName().'='.$session->getId(); ?>&amp;<?php echo (FLEXI_J30GE ? JSession::getFormToken() : JUtility::getToken());?>=1" class="form-validate form-horizontal" name="addUrlForm" id="addUrlForm" method="post">
          <fieldset class="filemanager-tab" >
            <fieldset class="actions" id="filemanager-2">
              <div class="fc-form-tbl" id="file-url-form-container">
                <div class="control-group">
                  <div class="control-label">
                    <label class="label <?php echo $tip_class; ?> required" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILE_URL', 'FLEXI_FILE_URL_DESC', 1, 1); ?>" for="file-url-data"> <?php echo JText::_( 'FLEXI_FILE_URL' ); ?> </label>
                  </div>
                  <div class="controls">
                ...
                <div class="control-group">
                  <div class="control-label">
                    <label class="label <?php echo $tip_class; ?> required" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILE_DISPLAY_TITLE', 'FLEXI_FILE_DISPLAY_TITLE_DESC', 1, 1); ?>" for="file-url-title"> <?php echo JText::_( 'FLEXI_FILE_DISPLAY_TITLE' ); ?> </label>
                  </div>
                  <div class="controls">
                ...
                <div class="control-group">
                  <div class="control-label">
                    <label class="label <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_LANGUAGE', 'FLEXI_FILE_LANGUAGE_DESC', 1, 1); ?>" id="file-url-lang-lbl" for="file-url-lang"> <?php echo JText::_( 'FLEXI_LANGUAGE' ); ?> </label>
                  </div>
                  <div class="controls"> <?php echo str_replace('file-lang', 'file-url-lang', $this->lists['file-lang']); ?> </div>
                </div>
                <div class="control-group">
                  <div class="control-label">
                    <label class="label <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_DESCRIPTION', 'FLEXI_FILE_DESCRIPTION_DESC', 1, 1); ?>" for="file-url-desc"> <?php echo JText::_( 'FLEXI_DESCRIPTION' ); ?> </label>
                  </div>
                  <div class="controls">
                ...
                <div class="control-group">
                  <div class="control-label">
                    <label class="label <?php echo $tip_class; ?> required" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILEEXT_MIME', 'FLEXI_FILEEXT_MIME_DESC', 1, 1); ?>" for="file-url-ext"> <?php echo JText::_( 'FLEXI_FILEEXT_MIME' ); ?> </label>
                  </div>
                  <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label">&nbsp;</div>
                <div class="controls">
                  <input type="submit" id="file-url-submit" class="<?php echo $btn_class;?> btn-primary validate" value="<?php echo JText::_( 'FLEXI_ADD_FILE' ); ?>"/>
                </div>
              </div>
            </fieldset>
          </fieldset>
      ...
      <div class="tabbertab" id="server_tab" data-icon-class="icon-file">
        ...
        <form action="index.php?option=com_flexicontent&amp;<?php echo $ctrl_task; ?>addlocal&amp;<?php echo $session->getName().'='.$session->getId(); ?>&amp;<?php echo (FLEXI_J30GE ? JSession::getFormToken() : JUtility::getToken());?>=1" class="form-validate form-horizontal" name="addFileForm" id="addFileForm" method="post">
          <fieldset class="filemanager-tab" >
            <fieldset class="actions" id="filemanager-3">
              <div class="fc-form-tbl" id="add-files-form-container">
              <div class="control-group">
                <div class="control-label">
                  <label class="label <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_CHOOSE_SRC_DIR', 'FLEXI_CHOOSE_SRC_DIR_DESC', 1, 1); ?>" for="file-dir-path"> <?php echo JText::_( 'FLEXI_CHOOSE_SRC_DIR' ); ?> </label>
                </div>
                <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label">
                  <label class="label <?php echo $tip_class; ?>" id="_file-lang-lbl" for="_file-lang" title="<?php echo flexicontent_html::getToolTip('FLEXI_LANGUAGE', 'FLEXI_FILE_LANGUAGE_DESC', 1, 1); ?>"> <?php echo JText::_( 'FLEXI_LANGUAGE' ); ?> </label>
                </div>
              ...
              <div class="control-group">
                <div class="control-label">
                  <label class="label <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILE_FILTER_EXT', 'FLEXI_FILE_FILTER_EXT_DESC', 1, 1); ?>" for="file-filter-ext"> <?php echo JText::_( 'FLEXI_FILE_FILTER_EXT' ); ?> </label>
                </div>
                <div class="controls">
                  <input type="text <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_DESCRIPTION', 'FLEXI_FILE_DESCRIPTION_DESC', 1, 1); ?>" id="file-filter-ext" size="50" value="" name="file-filter-ext" />
                </div>
              </div>
              <div class="control-group">
                <div class="control-label">
                  <label class="label" for="file-desc_addFileForm"> <?php echo JText::_( 'FLEXI_DESCRIPTION' ); ?> </label>
                </div>
                <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label">
                  <label class="label <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_FILE_FILTER_REGEX', 'FLEXI_FILE_FILTER_REGEX_DESC', 1, 1); ?>" for="file-filter-re"> <?php echo JText::_( 'FLEXI_FILE_FILTER_REGEX' ); ?> </label>
                </div>
                <div class="controls">
              ...
              <div class="control-group">
                <div class="control-label">
                  <label class="label <?php echo $tip_class; ?>" title="<?php echo flexicontent_html::getToolTip('FLEXI_KEEP_ORIGINAL_FILE', 'FLEXI_KEEP_ORIGINAL_FILE_DESC', 1, 1); ?>"> <?php echo JText::_( 'FLEXI_KEEP_ORIGINAL_FILE' ); ?> </label>
                </div>
                <div class="controls">
                  <?php
              ...
              <div class="control-group">
                <div class="control-label">
                  <label class="label <?php echo $tip_class; ?>" data-placement="bottom" title="<?php echo flexicontent_html::getToolTip('FLEXI_CHOOSE_DIRECTORY', 'FLEXI_CHOOSE_DIRECTORY_DESC', 1, 1); ?>"> <?php echo JText::_( 'FLEXI_TARGET_DIRECTORY' ); ?> </label>
                </div>
                <div class="controls">
                  <?php
      ...
      <div class="tabbertab" id="local_tab" data-icon-class="icon-info">
