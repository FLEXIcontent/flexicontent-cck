...
<div class="fctabber" id="fileman_tabset">
	...
	<div class="tabbertab" id="filelist_tab" data-icon-class="icon-list">
		...
		<?php if (!$this->folder_mode) : ?>
			<tfoot>
				...
				<tr>
					<td colspan="<?php echo $list_total_cols; ?>" align="center" style="border-top:0px solid black;">
		...
		<form action="index.php?option=com_flexicontent&amp;<?php echo $ctrl_task; ?>ftpValidate" name="ftpForm" id="ftpForm" method="post">
			<fieldset title="<?php echo JText::_( 'FLEXI_DESCFTPTITLE' ); ?>">
				...
				<table class="adminform nospace">
					<tbody>
						<tr>
							<td><label for="username"><?php echo JText::_( 'FLEXI_USERNAME' ); ?>:</label></td>
							<td><input type="text" id="username" name="username" class="input_box" size="70" value="" /></td>
						</tr>
						<tr>
							<td><label for="password"><?php echo JText::_( 'FLEXI_PASSWORD' ); ?>:</label></td>
	...
	<div class="tabbertab" id="local_tab" data-icon-class="icon-info">
		...
		<div id="why_box" style="margin:10px 10px 48px 0px;">
