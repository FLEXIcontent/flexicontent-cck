...
$secure_folder_tip  = '<i data-placement="bottom" class="icon-info fc-man-icon-s '.$tip_class.'" title="'.flexicontent_html::getToolTip($_folder_type_title, $_folder_type_desc, 0, 1).'"></i>';
...
<div class="fctabber" id="fileman_tabset">
	...
	<div class="tabbertab" id="local_tab" data-icon-class="icon-upload">
		...
		<?php if (!$this->folder_mode) { ?>
						...
						<tr>
							<td id="secure-lbl-container" class="key <?php echo $tip_class; ?>" data-placement="top" title="<?php echo flexicontent_html::getToolTip('FLEXI_CHOOSE_DIRECTORY', 'FLEXI_CHOOSE_DIRECTORY_DESC', 1, 1); ?>">
