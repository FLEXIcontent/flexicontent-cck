...
var $proxy_option = null;
	...
	public function display($tpl = null)
	{
		...
		// SET toolbar title
		!$isnew
			? \Joomla\CMS\Toolbar\ToolbarHelper::title(\Joomla\CMS\Language\Text::_('FLEXI_EDIT_REVIEW'), 'reviewedit')
			: \Joomla\CMS\Toolbar\ToolbarHelper::title(\Joomla\CMS\Language\Text::_('FLEXI_NEW_REVIEW'), 'reviewadd');
