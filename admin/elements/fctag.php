...
class JFormFieldFctag extends JFormField
{
	...
	function getInput()
	{
		...
		$_select = JText::_('FLEXI_SELECT_TAG', true);
		return '
		<span class="input-append">
			...
			'.($allowEdit ? '
			<a id="' .$element_id. '_edit" class="btn ' . ($this->value ? '' : ' hidden') . ' hasTooltip" href="index.php?option=com_flexicontent&amp;task=tag.edit&amp;cid=' . $this->value . '" target="_blank" title="'.JText::_( 'FLEXI_EDIT_TAG' ).'">
