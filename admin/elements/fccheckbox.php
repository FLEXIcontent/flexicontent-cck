  ...
  var $type = 'Fccheckbox';
	...
	function getInput()
	{
		...
		if ( @$attributes['display_useglobal'] ) {
			...
			$html .= '<div><input id="'.$element_id.'_useglobal" type="checkbox" '.$check_global.' name="'.$fieldname.'" value="__USE_GLOBAL__" onclick="fc_toggle_checkbox_group(\''.$element_id.'\', this)" />';
