...
use Joomla\CMS\Log\Log;                      // Remplace /* TODO-J5: JError removed */ JError::raiseWarning() (supprimé en J4)
...
class JFormFieldFcMenuitem extends GroupedlistField
{
	...
	)
	{
		...
		{
			// J4+ : Log::add() remplace /* TODO-J5: JError removed */ JError::raiseWarning() (supprimé en J4)
