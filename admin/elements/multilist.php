	...
	*/
	...
	function getInput()
	{
		...
		if ($inline_tip = @$attributes['inline_tip'])
		{
			...
			$previewimage = $preview_img ? JHTML::image ( 'administrator/components/com_flexicontent/assets/images/'.$preview_img, JText::_( 'FLEXI_NOTES' ), ' align="left" style="max-height:24px; padding:0px; margin:0 0 0 12px;" ' ) : '';
