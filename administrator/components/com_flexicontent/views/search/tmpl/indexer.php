...
jQuery(document).ready(function() {
	...
	function updateprogress() {
		...
		jQuery.ajax({
			url: "index.php?option=com_flexicontent&controller=search&task=index&items_per_call="+items_per_call+"&itemcnt="+looper+"&indexer=<?php echo JRequest::getVar('indexer','advanced');?>",
