<?php
/**
 * @version 1.5 beta 5 $Id: items.php 184 2009-11-20 11:27:04Z vistamedia $
 * @package Joomla
...
class FlexicontentModelItems extends JModel
{
	...
	function getUnassociatedItems($limit = 1000000)
	{
		...
		if ($status['no']) {
			...
			$query 	= 'SELECT id, title, introtext, `fulltext`, catid, created, created_by, modified, modified_by, state FROM #__content'
					. ' WHERE sectionid = ' . FLEXI_SECTION
					. $and
					;
