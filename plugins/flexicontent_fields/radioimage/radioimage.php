<?php
/**
 * @version 1.0 $Id: radioimage.php 1629 2013-01-19 08:45:07Z ggppdk $
 * @package Joomla
...
class plgFlexicontent_fieldsRadioimage extends FCField
{
	...
	function onDisplayField(&$field, &$item)
	{
		...
		if ($ajax) {
			...
			if (!$add_position) $field->html .= '<span class="fcfield-addvalue ' . $font_icon_class . '" onclick="addField'.$field->id.'(this);" title="'.JText::_( 'FLEXI_ADD_TO_BOTTOM' ).'">'.JText::_( 'FLEXI_ADD_VALUE' ).'</span>';
