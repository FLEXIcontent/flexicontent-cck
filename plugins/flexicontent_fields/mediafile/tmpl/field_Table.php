...
foreach ($field->value as $file_id)
{
	...
	if ($use_inline_uploaders)
	{
		...
		$uploader_html->mediaUrlBtn = !$usemediaurl ? '' : '
			<span class="' . ($file_btns_position ? $btn_item_class : $btn_item_class) . ' fcfield-medialurlvalue ' . $font_icon_class . ' dropdown-item" onclick="fcfield_mediafile.toggleMediaURL(\''.$elementid_n.'\', \''.$field_name_js.'\'); return false;">
