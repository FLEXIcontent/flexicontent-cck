...
// email button REMOVE FOR NEW SYSTEM
...
//		/* J5/J6 WebAsset: */ $document->getWebAssetManager()->registerAndUseScript('fc-script', \Joomla\CMS\Uri\Uri::root(true).'/plugins/flexicontent_fields/toolbar/toolbar/th.js');
//	} else {
...
//	'.( $lang=='th' ? '
//		<span class="voice-legend flexi-legend"><a href="javascript:void(0);" onclick="openwindow(\''.$voicetarget.'\',\''.$lang.'\');"        class="mainlevel-toolbar-article-horizontal" rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M533.6 32.5C598.5 85.3 640 165.8 640 256s-41.5 170.8-106.4 223.5c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C557.5 398.2 592 331.2 592 256s-34.5-142.2-88.7-186.3c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zM473.1 107c43.2 35.2 70.9 88.9 70.9 149s-27.7 113.8-70.9 149c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C475.3 341.3 496 301.1 496 256s-20.7-85.3-53.2-111.8c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zm-60.5 74.5C434.1 199.1 448 225.9 448 256s-13.9 56.9-35.4 74.5c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C393.1 284.4 400 271 400 256s-6.9-28.4-17.7-37.3c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zM301.1 34.8C312.6 40 320 51.4 320 64V448c0 12.6-7.4 24-18.9 29.2s-25 3.1-34.4-5.3L131.8 352H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h67.8L266.7 40.1c9.4-8.4 22.9-10.4 34.4-5.3z"/></svg>' . \Joomla\CMS\Language\Text::_('FLEXI_FIELD_TOOLBAR_VOICE') . '</a></span>' : '
//		<span class="voice-legend flexi-legend"><a href="javascript:void(0);"     onclick="get_id(\''.$voicetarget.'\',\''.$lang.'\',\'fm\');" class="mainlevel-toolbar-article-horizontal" rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M533.6 32.5C598.5 85.3 640 165.8 640 256s-41.5 170.8-106.4 223.5c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C557.5 398.2 592 331.2 592 256s-34.5-142.2-88.7-186.3c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zM473.1 107c43.2 35.2 70.9 88.9 70.9 149s-27.7 113.8-70.9 149c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C475.3 341.3 496 301.1 496 256s-20.7-85.3-53.2-111.8c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zm-60.5 74.5C434.1 199.1 448 225.9 448 256s-13.9 56.9-35.4 74.5c-10.3 8.4-25.4 6.8-33.8-3.5s-6.8-25.4 3.5-33.8C393.1 284.4 400 271 400 256s-6.9-28.4-17.7-37.3c-10.3-8.4-11.8-23.5-3.5-33.8s23.5-11.8 33.8-3.5zM301.1 34.8C312.6 40 320 51.4 320 64V448c0 12.6-7.4 24-18.9 29.2s-25 3.1-34.4-5.3L131.8 352H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h67.8L266.7 40.1c9.4-8.4 22.9-10.4 34.4-5.3z"/></svg>' . \Joomla\CMS\Language\Text::_('FLEXI_FIELD_TOOLBAR_VOICE') . '</a></span>' ).'
//	</div>
//	';
//}
...
//check if fiexed
if ($display_list_item == 2){
	$class_position ='toolbarfixed';
}else{
	$class_position ='';
}

//display sharing button like a list
if (($display_list_item == 1 && $view === 'item') || ($display_list_category == 1 && $view === 'category')  ){
	$before_list ='<div class="dropdown flexi-share-dropdown">
	...
	foreach ($display_sharing_buttons_item as $display_sharing_button_item)
	{
		if ($display_sharing_button_item === 'fb'){
			$value .=$before_value.'<!-- Sharingbutton Facebook -->
                <a class="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="Facebook">
		...
		if ($display_sharing_button_item === 'tw'){
			$value.=$before_value.'<!-- Sharingbutton Twitter -->
            <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text='.$item_title_escaped.'&amp;url='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="X">
		...
		if ($display_sharing_button_item === 'tb'){
			$value.=$before_value.'<!-- Sharingbutton Tumblr -->
            <a class="resp-sharing-button__link" href="https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title='.$item_title_escaped.'&amp;caption='.$item_title_escaped.'&amp;content='.$item_url_abs.'&amp;canonicalUrl='.$item_url_abs.'&amp;shareSource=tumblr_share_button" target="_blank" rel="noopener" aria-label="Tumblr">
		...
		if ($display_sharing_button_item === 'email'){
			$value.=$before_value.'<!-- Sharingbutton E-Mail -->
            <a class="resp-sharing-button__link" href="mailto:?subject='.$item_title_escaped.'&amp;body='.$item_url_abs.'" target="_self" rel="noopener" aria-label="E-Mail">
		...
		if ($display_sharing_button_item === 'pin'){
			$value.=$before_value.'<!-- Sharingbutton Pinterest -->
            <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url='.$item_url_abs.'&amp;media='.$item_url_abs.'&amp;description='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="Pinterest">
		...
		if ($display_sharing_button_item === 'lin'){
			$value.=$before_value.'<!-- Sharingbutton LinkedIn -->
            <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url='.$item_url_abs.'&amp;title='.$item_title_escaped.'&amp;summary='.$item_title_escaped.'&amp;source='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="LinkedIn">
		...
		if ($display_sharing_button_item === 'red'){
			$value.=$before_value.'<!-- Sharingbutton Reddit -->
            <a class="resp-sharing-button__link" href="https://reddit.com/submit/?url='.$item_url_abs.'&amp;resubmit=true&amp;title='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="Reddit">
		...
		if ($display_sharing_button_item === 'xin'){
			$value.=$before_value.'<!-- Sharingbutton XING -->
            <a class="resp-sharing-button__link" href="https://www.xing.com/app/user?op=share;url='.$item_url_abs.';title='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="XING">
		...
		if ($display_sharing_button_item === 'what'){
            ...
            <a class="resp-sharing-button__link" href="whatsapp://send?text='.$item_title_escaped.''.$item_url_abs.'" target="_blank" rel="noopener" aria-label="WhatsApp">
		...
		if ($display_sharing_button_item === 'ycom'){
			$value.=$before_value.'<!-- Sharingbutton Hacker News -->
            <a class="resp-sharing-button__link" href="https://news.ycombinator.com/submitlink?u='.$item_url_abs.'&amp;t='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="Hacker News">
		...
		if ($display_sharing_button_item === 'vk'){
			$value.=$before_value.'<!-- Sharingbutton VK -->
            <a class="resp-sharing-button__link" href="http://vk.com/share.php?title='.$item_title_escaped.'&amp;url='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="VK">
		...
		if ($display_sharing_button_item === 'tel'){
            ...
            <a class="resp-sharing-button__link" href="https://telegram.me/share/url?text='.$item_title_escaped.'&amp;url='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="Telegram">
...
elseif ($view === 'category')
{
	foreach ($display_sharing_buttons_category as $display_sharing_button_category){
		...
		if ($display_sharing_button_category === 'tw'){
			$value.=$before_value.'<!-- Sharingbutton Twitter -->
          <a class="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text='.$item_title_escaped.'&amp;url='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="X">
            <div class="resp-sharing-button resp-sharing-button--twitter resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M23.44 4.83c-.8.37-1.5.38-2.22.02.93-.56.98-.96 1.32-2.02-.88.52-1.86.9-2.9 1.1-.82-.88-2-1.43-3.3-1.43-2.5 0-4.55 2.04-4.55 4.54 0 .36.03.7.1 1.04-3.77-.2-7.12-2-9.36-4.75-.4.67-.6 1.45-.6 2.3 0 1.56.8 2.95 2 3.77-.74-.03-1.44-.23-2.05-.57v.06c0 2.2 1.56 4.03 3.64 4.44-.67.2-1.37.2-2.06.08.58 1.8 2.26 3.12 4.25 3.16C5.78 18.1 3.37 18.74 1 18.46c2 1.3 4.4 2.04 6.97 2.04 8.35 0 12.92-6.92 12.92-12.93 0-.2 0-.4-.02-.6.9-.63 1.96-1.22 2.56-2.14z"/></svg>
		...
		if ($display_sharing_button_category === 'tb'){
			$value.=$before_value.'<!-- Sharingbutton Tumblr -->
          <a class="resp-sharing-button__link" href="https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title='.$item_title_escaped.'&amp;caption='.$item_title_escaped.'&amp;content='.$item_url_abs.'&amp;canonicalUrl='.$item_url_abs.'&amp;shareSource=tumblr_share_button" target="_blank" rel="noopener" aria-label="Tumblr">
            <div class="resp-sharing-button resp-sharing-button--tumblr resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13.5.5v5h5v4h-5V15c0 5 3.5 4.4 6 2.8v4.4c-6.7 3.2-12 0-12-4.2V9.5h-3V6.7c1-.3 2.2-.7 3-1.3.5-.5 1-1.2 1.4-2 .3-.7.6-1.7.7-3h3.8z"/></svg>
		...
		if ($display_sharing_button_category === 'email'){
			$value.=$before_value.'<!-- Sharingbutton E-Mail -->
          <a class="resp-sharing-button__link" href="mailto:?subject='.$item_title_escaped.'&amp;body='.$item_url_abs.'" target="_self" rel="noopener" aria-label="E-Mail">
            <div class="resp-sharing-button resp-sharing-button--email resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22 4H2C.9 4 0 4.9 0 6v12c0 1.1.9 2 2 2h20c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM7.25 14.43l-3.5 2c-.08.05-.17.07-.25.07-.17 0-.34-.1-.43-.25-.14-.24-.06-.55.18-.68l3.5-2c.24-.14.55-.06.68.18.14.24.06.55-.18.68zm4.75.07c-.1 0-.2-.03-.27-.08l-8.5-5.5c-.23-.15-.3-.46-.15-.7.15-.22.46-.3.7-.14L12 13.4l8.23-5.32c.23-.15.54-.08.7.15.14.23.07.54-.16.7l-8.5 5.5c-.08.04-.17.07-.27.07zm8.93 1.75c-.1.16-.26.25-.43.25-.08 0-.17-.02-.25-.07l-3.5-2c-.24-.13-.32-.44-.18-.68s.44-.32.68-.18l3.5 2c.24.13.32.44.18.68z"/></svg>
		...
		if ($display_sharing_button_category === 'pin'){
			$value.= $before_value.'<!-- Sharingbutton Pinterest -->
          <a class="resp-sharing-button__link" href="https://pinterest.com/pin/create/button/?url='.$item_url_abs.'&amp;media='.$item_url_abs.'&amp;description='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="Pinterest">
            <div class="resp-sharing-button resp-sharing-button--pinterest resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12.14.5C5.86.5 2.7 5 2.7 8.75c0 2.27.86 4.3 2.7 5.05.3.12.57 0 .66-.33l.27-1.06c.1-.32.06-.44-.2-.73-.52-.62-.86-1.44-.86-2.6 0-3.33 2.5-6.32 6.5-6.32 3.55 0 5.5 2.17 5.5 5.07 0 3.8-1.7 7.02-4.2 7.02-1.37 0-2.4-1.14-2.07-2.54.4-1.68 1.16-3.48 1.16-4.7 0-1.07-.58-1.98-1.78-1.98-1.4 0-2.55 1.47-2.55 3.42 0 1.25.43 2.1.43 2.1l-1.7 7.2c-.5 2.13-.08 4.75-.04 5 .02.17.22.2.3.1.14-.18 1.82-2.26 2.4-4.33.16-.58.93-3.63.93-3.63.45.88 1.8 1.65 3.22 1.65 4.25 0 7.13-3.87 7.13-9.05C20.5 4.15 17.18.5 12.14.5z"/></svg>
		...
		if ($display_sharing_button_category === 'lin'){
			$value.=$before_value.'<!-- Sharingbutton LinkedIn -->
          <a class="resp-sharing-button__link" href="https://www.linkedin.com/shareArticle?mini=true&amp;url='.$item_url_abs.'&amp;title='.$item_title_escaped.'&amp;summary='.$item_title_escaped.'&amp;source='.$item_url_abs.'" target="_blank" rel="noopener" aria-label="LinkedIn">
            <div class="resp-sharing-button resp-sharing-button--linkedin resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6.5 21.5h-5v-13h5v13zM4 6.5C2.5 6.5 1.5 5.3 1.5 4s1-2.4 2.5-2.4c1.6 0 2.5 1 2.6 2.5 0 1.4-1 2.5-2.6 2.5zm11.5 6c-1 0-2 1-2 2v7h-5v-13h5V10s1.6-1.5 4-1.5c3 0 5 2.2 5 6.3v6.7h-5v-7c0-1-1-2-2-2z"/></svg>
		...
		if ($display_sharing_button_category === 'red'){
			$value.=$before_value.'<!-- Sharingbutton Reddit -->
          <a class="resp-sharing-button__link" href="https://reddit.com/submit/?url='.$item_url_abs.'&amp;resubmit=true&amp;title='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="Reddit">
            <div class="resp-sharing-button resp-sharing-button--reddit resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M24 11.5c0-1.65-1.35-3-3-3-.96 0-1.86.48-2.42 1.24-1.64-1-3.75-1.64-6.07-1.72.08-1.1.4-3.05 1.52-3.7.72-.4 1.73-.24 3 .5C17.2 6.3 18.46 7.5 20 7.5c1.65 0 3-1.35 3-3s-1.35-3-3-3c-1.38 0-2.54.94-2.88 2.22-1.43-.72-2.64-.8-3.6-.25-1.64.94-1.95 3.47-2 4.55-2.33.08-4.45.7-6.1 1.72C4.86 8.98 3.96 8.5 3 8.5c-1.65 0-3 1.35-3 3 0 1.32.84 2.44 2.05 2.84-.03.22-.05.44-.05.66 0 3.86 4.5 7 10 7s10-3.14 10-7c0-.22-.02-.44-.05-.66 1.2-.4 2.05-1.54 2.05-2.84zM2.3 13.37C1.5 13.07 1 12.35 1 11.5c0-1.1.9-2 2-2 .64 0 1.22.32 1.6.82-1.1.85-1.92 1.9-2.3 3.05zm3.7.13c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm9.8 4.8c-1.08.63-2.42.96-3.8.96-1.4 0-2.74-.34-3.8-.95-.24-.13-.32-.44-.2-.68.15-.24.46-.32.7-.18 1.83 1.06 4.76 1.06 6.6 0 .23-.13.53-.05.67.2.14.23.06.54-.18.67zm.2-2.8c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm5.7-2.13c-.38-1.16-1.2-2.2-2.3-3.05.38-.5.97-.82 1.6-.82 1.1 0 2 .9 2 2 0 .84-.53 1.57-1.3 1.87z"/></svg>
		...
		if ($display_sharing_button_category === 'ycom'){
			$value.=$before_value.'<!-- Sharingbutton Hacker News -->
          <a class="resp-sharing-button__link" href="https://news.ycombinator.com/submitlink?u='.$item_url_abs.'&amp;t='.$item_title_escaped.'" target="_blank" rel="noopener" aria-label="Hacker News">
            <div class="resp-sharing-button resp-sharing-button--hackernews resp-sharing-button--small"><div aria-hidden="true" class="resp-sharing-button__icon resp-sharing-button__icon--solid">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 140"><path fill-rule="evenodd" d="M60.94 82.314L17 0h20.08l25.85 52.093c.397.927.86 1.888 1.39 2.883.53.994.995 2.02 1.393 3.08.265.4.463.764.596 1.095.13.334.262.63.395.898.662 1.325 1.26 2.618 1.79 3.877.53 1.26.993 2.42 1.39 3.48 1.06-2.254 2.22-4.673 3.48-7.258 1.26-2.585 2.552-5.27 3.877-8.052L103.49 0h18.69L77.84 83.308v53.087h-16.9v-54.08z"></path></svg>
...
switch ($view)
{
	case 'item': $html = $before_list .$value. $after_list; break;
	case 'category': $html = $before_list .$value. $after_list; break;
}


$field->{$prop}	= !empty($html)
	? '
	<div class="flexitoolbar '.$class_position.'">
		' . implode('<div class="toolbar-spacer"'.$spacer.'></div>', $ops). $opentag . $html . $closetag . '
	</div>'
	: '';