...
foreach ($field->value as $file_id)
{
	...
	<div style="display:inline-block;">
		...
		'.(!$iform_title ? '<div class="'.$input_grp_class.'"><span class="' . $add_on_class . ' fc-lbl fc_filedata_title-lbl">'.JText::_( 'FLEXI_FILE_DISPLAY_TITLE' ).'</span><span class="' . $add_on_class . ' fc_filedata_title">'. ($file_data->altname && $filename_original!=$file_data->altname ? $file_data->altname : '-').'</span></div>' : '').'
		<br/>
