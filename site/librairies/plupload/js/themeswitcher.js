...
jQuery.fn.themeswitcher = function(settings){
	...
	switcherpane.find('a').click(function(){
		...
		// jQuery.cookie(options.cookieName, themeName); original bug
        jQuery.cookie(options.cookieName, themeName, options); // jasonlau.biz
		options.onSelect();
	...
	function updateCSS(locStr){
		...
		var link = jQuery("link.ui-theme");
		if (!link.length) {
			link = jQuery('link[href$="jquery-ui.css"]');
		}
