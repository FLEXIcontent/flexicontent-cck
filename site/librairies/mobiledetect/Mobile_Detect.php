...
class Mobile_Detect_FC
{
    ...
    {
	    $match = !empty($userAgent) || !empty($this->userAgent)
		    ? (bool) preg_match(sprintf('#%s#is', $regex), (false === empty($userAgent) ? $userAgent : $this->userAgent), $matches)
		    : false;
