...
JLoader::register('flexicontent_csvmedia', JPATH_SITE.DS.'components'.DS.'com_flexicontent'.DS.'classes'.DS.'helpers'.DS.'csvmedia.php');
JLoader::register('flexicontent_remote', JPATH_SITE.DS.'components'.DS.'com_flexicontent'.DS.'classes'.DS.'helpers'.DS.'remote.php');
