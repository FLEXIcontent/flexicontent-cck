...
switch ( \Joomla\CMS\Factory::getApplication()->getConfig()->get('error_reporting') )  // Set the error_reporting
{
	case 'default': case '-1':
		break;
	...
	default:
		error_reporting( \Joomla\CMS\Factory::getApplication()->getConfig()->get('error_reporting') );
		ini_set('display_errors', 1);
		break;
}
