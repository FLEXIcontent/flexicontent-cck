<?php
/**
 * @version 1.5 stable $Id: fileselement.php 1579 2012-12-03 03:37:21Z ggppdk $
 * @package Joomla
...
class FlexicontentModelFileselement extends JModelLegacy
{
	...
	function __construct()
	{
		...
		$limitstart = $mainframe->getUserStateFromRequest( $option.'.fileselement.limitstart', 'limitstart', 0, 'int' );
