...
class FlexicontentHelperRoute
{
	...
	function _setComponentMenuitems ()
	{
		...
		$_component_menuitems	= $menus->getItems('componentid', $component->id);
	...
	function _findItem($needles)
	{
		...
		{								
			if ((@$menuitem->query['view'] == 'items') && (@$menuitem->query['id'] == $needles['items'])) {
				if ((@$menuitem->query['view'] == 'items') && (@$menuitem->query['cid'] == $needles['category'])) {
