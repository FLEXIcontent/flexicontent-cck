	...
	<ul class="leadingblock group row">
		...
		<li class="span12">
			...
			<?php endif; ?>	
				...
				<?php if ( ($this->params->get('show_title', 1)) && ( ($this->params->get('show_readmore', 1) && strlen(trim($items[$i]->fulltext)) >= 1) ||  $this->params->get('intro_strip_html', 1) == 1 ) || ($item->event->afterDisplayContent) ) : ?>
					<footer>
				<?php endif; ?>
...
?>
	<ul class="introblock <?php echo $classnum; ?> group row">	
		...
		<li class="<?php echo (($this->limitstart == 0) ? ($i+$leadnum)%2 : $i%2) ? 'even' : 'odd'; ?> <?php echo $classspan; ?>">
			<?php if ($this->params->get('show_title', 1)) : ?>
				<article class="group">
			<?php endif; ?>
