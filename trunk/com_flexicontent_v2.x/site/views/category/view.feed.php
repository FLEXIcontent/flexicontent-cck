<?php
/**
 * @version 1.5 stable $Id: view.feed.php 171 2010-03-20 00:44:02Z emmanuel.danan $
 * @package Joomla
...
//			$link = JRoute::_('index.php?option=com_flexicontent&view=item&cid='. $category->slug .'&id='.$row->slug );
