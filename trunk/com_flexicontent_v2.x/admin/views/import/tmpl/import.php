<?php
/**
 * @version 1.5 stable $Id: import.php 1738 2013-08-24 17:42:17Z ggppdk $
 * @package Joomla
				...
				<table class="fcimporttbl">
					...
					<tr valign="top">
						...
						<td class="fcimportdata">
							...
							<label for="created_col0" class="fcdata">a. <?php echo JText::_("FLEXI_IMPORT_CREATION_CURR_DATE");?></label>
							<input type="radio" id="created_col1" name="created_col" value="1" <?php echo $checked1; ?> />
							<label for="created_col1" class="fcdata">b. <?php echo JText::_("FLEXI_IMPORT_CREATION_USE_COL");?></label>
						</td>
					</tr>
					<tr valign="top">
						...
						<td class="fcimportdata">
							...
							<label for="created_by_col0" class="fcdata">a. <?php echo JText::_("FLEXI_IMPORT_CREATOR_CURR_USER");?></label>
							<input type="radio" id="created_by_col1" name="created_by_col" value="1" <?php echo $checked1; ?> />
							<label for="created_by_col1" class="fcdata">b. <?php echo JText::_("FLEXI_IMPORT_CREATOR_USE_COL");?></label>
						</td>
					</tr>
					<tr valign="top">
						...
						<td class="fcimportdata">
							...
							<label for="metadesc_col" class="fcdata"><?php echo JText::_("FLEXI_IMPORT_USE_METADESC_COL");?></label>
							<input type="checkbox" id="metakey_col" name="metakey_col" value="1" <?php echo $_key_checked; ?> />
							<label for="metakey_col" class="fcdata"><?php echo JText::_("FLEXI_IMPORT_USE_METAKEY_COL");?></label>
						</td>
					<tr valign="top">
						...
						<td class="fcimportdata">
							...
							<label for="publish_up_col" class="fcdata"><?php echo JText::_("FLEXI_IMPORT_USE_PUBLISH_UP_COL");?></label>
							<input type="checkbox" id="publish_down_col" name="publish_down_col" value="1" <?php echo $_down_checked; ?> />
							<label for="publish_down_col" class="fcdata"><?php echo JText::_("FLEXI_IMPORT_USE_PUBLISH_DOWN_COL");?></label>
						</td>
					</tr>
					<tr valign="top">
						...
						<td class="fcimportdata">
							...
							<label for="tags_col0" class="fcdata">a. <?php echo JText::_("FLEXI_IMPORT_DO_NOT_IMPORT_TAGS");?></label>
							<input type="radio" id="tags_col1" name="tags_col" value="1" <?php echo $checked1; ?> />
							<label for="tags_col1" class="fcdata">b. <?php echo JText::_("FLEXI_IMPORT_USE_TAG_NAMES_COL");?></label>
							<input type="radio" id="tags_col2" name="tags_col" value="2" <?php echo $checked2; ?> />
							<label for="tags_col2" class="fcdata">c. <?php echo JText::_("FLEXI_IMPORT_USE_TAG_IDS_COL");?></label>
						</td>
					</tr>
				</table>
			</fieldset>
