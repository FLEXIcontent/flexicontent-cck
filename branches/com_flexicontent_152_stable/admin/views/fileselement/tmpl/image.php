<?php
/**
 * @version 1.5 stable $Id: image.php 183 2009-11-18 10:30:48Z vistamedia $
 * @package Joomla
...
<form action="index.php?option=com_flexicontent&amp;view=fileselement&amp;field=<?php echo $this->fieldid?>&amp;tmpl=component&amp;layout=image&amp;filter_secure=M" method="post" name="adminForm">
	...
	<tbody>
		...
		$src = '../components/com_flexicontent/librairies/phpthumb/phpThumb.php?src=../../../../' . $mediapath . DS . $row->filename . '&w=60&h=60';
		$srcb = '../components/com_flexicontent/librairies/phpthumb/phpThumb.php?src=../../../../' . $mediapath . DS . $row->filename . '&w=200&h=200';
   		?>
