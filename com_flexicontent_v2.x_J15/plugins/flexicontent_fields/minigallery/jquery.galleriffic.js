...
;(function(jQuery) {
	...
	var defaults = {
		...
		onBeforeSlideChange:       undefined, // accepts a delegate like such: function(prevIndex, nextIndex) { ... }
		onAfterSlideChange:        undefined, // accepts a delegate like such: function(prevIndex, nextIndex) { ... }
	...
	jQuery.fn.galleriffic = function(settings) {
		...
		jQuery.extend(this, {
			...
			gotoImage: function(imageData) {
				...
				if (this.onBeforeSlideChange)
					this.onBeforeSlideChange(this.currentImage.index, index);
				...
				if (this.onAfterSlideChange)
					this.onAfterSlideChange(this.currentImage.index, index);
			...
			buildImage: function(imageData, isSync) {
				...
				var newSlide = this.$imageContainer
					.append('<span class="image-wrapper current"><a class="advance-link" rel="'+imageData.gallery.rel+'" href="'+imageData.slideUrl+'#'+this.data[nextIndex].hash+'" title="'+imageData.title+'"></a></span>')
			...
			buildPager: function(pager) {
				...
				if (page > 0) {
					var prevPage = startIndex - this.numThumbs;
					pager.append('<a rel="'+gallery.rel+'" href="#'+this.data[prevPage].hash+'" title="'+this.prevPageLinkText+'">'+this.prevPageLinkText+'</a>');
				}
