	...
	Util.extend(Util, {
		...
		DOM: {
			...
			resetTranslate: function(el){
				...
				if (Util.browser.webkit){
					if (Util.browser.is3dSupported){
						jQuery(el).css({ webkitTransform: 'translate3d(0px, 0px, 0px)'});
					}
					else{
						jQuery(el).css({ webkitTransform: 'translate(0px, 0px)'});
					}
				}
				else {
					jQuery(el).css({
			...
			appendChild: function(childEl, parentEl){
				...
				jQuery(parentEl).append(childEl);
			...
			hasAttribute: function(el, attributeName){
				...
				return Util.isNothing( jQuery(el).attr(attributeName) );
			...
			setAttribute: function(el, attributeName, value){
				...
				jQuery(el).attr(attributeName, value);
			...
			removeAttribute: function(el, attributeName){
				...
				jQuery(el).removeAttr(attributeName);
			...
			getStyle: function(el, styleName){
				...
				return jQuery(el).css(styleName);
			...
			bodyWidth: function(){
				...
				return jQuery(document.body).width();
			...
			bodyHeight: function(){
				...
				return jQuery(document.body).height();
			...
			removeEventListener: function(el, type, listener){
				...
				jQuery(el).unbind( type,  listener );
	...
	Util.extend(Util, {
		...
		Animation: {
			...
			fadeIn: function(el, opacity, duration, callback){
				...
				jQuery(el).fadeTo(duration, opacity, callback);
			...
			fadeOut: function(el, duration, callback){
				...
				jQuery(el).fadeTo(duration, 0, callback);
